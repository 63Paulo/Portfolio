      ...
      return (
        <>
          <div class="about" id="about">
            <h1 class="aboutme homepageH1">A PROPOS DE MOI</h1>        
            <h2 class="aboutme">Je suis Paul Fernandes, un étudiant actuellement en première année de BTS SIO (Services Informatiques aux Organisations).
            ...
            <h1 class="competences homepageH1">COMPETENCES</h1>
            <h2 class="competences">Grâce à ma formation, j'ai acquis une solide maîtrise des langages suivants :
