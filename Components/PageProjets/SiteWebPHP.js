      ...
      return (
        <>
          <section className="SiteWebPHP">
            <h1 className="siteweb-h1">SITE WEB PHP</h1>
            ...
            <div className="organisation">
              ...
              <ul>
                <li>- Détermination des fonctionnalités et création de maquettes en collaboration.</li>
                <li>- Décomposition des contraintes en tâches plus petites durant les sprints, avec une répartition des responsabilités.</li>
                <li>- Utilisation de Git pour répertorier et gérer les tâches, avec des catégories pour suivre l'avancement.</li>
              </ul>
              <div className='img-container'>
                  <Image src={'/image/siteWebPHP/img-orga1.PNG'} width={1200} height={750}></Image>
              ...
              <div className="difficulte">
                ...
                <ul>
                  <li>- Ralentissement de l'avancement dû au manque de compétences en PHP et JavaScript.</li>
                  <li>- Interruptions fréquentes dues aux vacances et aux stages.</li>
                  <li>- Difficultés de coordination en dehors des heures de cours.</li>
                </ul>
              </div>
            </div>
          </section>
